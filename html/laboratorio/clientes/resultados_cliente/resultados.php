 ...
 <div class="row container">
    <div class="pull-right">
      <div class="mbr-navbar__column"><ul class="mbr-navbar__items mbr-navbar__items--right mbr-buttons mbr-buttons--freeze mbr-buttons--right btn-inverse mbr-buttons--active"><li class="mbr-navbar__item">
        ...
        <div class="mbr-navbar__column"><ul class="mbr-navbar__items mbr-navbar__items--right mbr-buttons mbr-buttons--freeze mbr-buttons--right btn-inverse mbr-buttons--active"><li class="mbr-navbar__item">
           <a class="mbr-buttons__btn btn btn-danger active" href="?view=resultados_clientes&mode=resultados">Reporte de resultados</a>
        </li></ul></div>
        <div class="mbr-navbar__column"><ul class="mbr-navbar__items mbr-navbar__items--right mbr-buttons mbr-buttons--freeze mbr-buttons--right btn-inverse mbr-buttons--active"><li class="mbr-navbar__item">
     ...
     <ol class="breadcrumb">
       <li><a href="?view=index"><i class="fa fa-tags"></i> Resultados </a></li>
     </ol>
 </div>

 <div class="row categorias_con_foros">
   <div class="col-sm-12">
       <div class="row titulo_categoria">Entrega de resultados</div>
            ...
            <tbody>';
             foreach($_resultados as $id_cliente => $cliente_array) {
                 ...
                 $HTML .= '<tr>
                   ...
                   <td><a target=\"_blank\" href="views/app/images/archivos/resultados/'.$_resultados[$id_cliente]['anexo'].'" title=\"'.$_resultados[$id_cliente]['anexo'].'\"<span aria-hidden="true"></span>'.$_resultados[$id_cliente]['anexo'].'</a></td>
                   <td>'.$_resultados[$id_cliente]['f_resultados'].'</td>
                   <td><a target=\"_blank\" href="views/app/images/archivos/resultados/'.$_resultados[$id_cliente]['resultados'].'" title=\"'.$_resultados[$id_cliente]['nombre_archivo'].'\"<span class="glyphicon glyphicon-file" aria-hidden="true"></span>'.$r=($_resultados[$id_cliente]['resultados']=="En proceso.pdf")?"En proceso":$_resultados[$id_cliente]['codigo'].'</a></td>
