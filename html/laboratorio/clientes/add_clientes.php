...
<div class="row container">
   <div class="pull-right">
        ...
        <div class="mbr-navbar__column"><ul class="mbr-navbar__items mbr-navbar__items--right mbr-buttons mbr-buttons--freeze mbr-buttons--right btn-inverse mbr-buttons--active"><li class="mbr-navbar__item">
            <a class="mbr-buttons__btn btn btn-danger active" href="?view=clientes&mode=add">CREAR CLIENTE</a>
        </li></ul></div>
     </div>
...
<div class="row categorias_con_foros">
  <div class="col-sm-12">
      ...
      <div class="row cajas">
        <div class="col-md-12">
          <form class="form-horizontal" action="?view=clientes&mode=add" method="POST" enctype="application/x-www-form-urlencoded">
            <fieldset>
              <div class="form-group">
                <label for="inputEmail" class="col-lg-2 control-label">Cliente</label>
                <div class="col-lg-10">
                  <input type="text" class="form-control" name="user" placeholder="Nombre del cliente">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" class="form-control" name="direccion" placeholder="Numero de dirección">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" class="form-control" name="departamento" placeholder="Nombre del departamento">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" class="form-control" name="nit" placeholder="Numero del NIT">
                </div>
              </div>
              <div class="form-group">
