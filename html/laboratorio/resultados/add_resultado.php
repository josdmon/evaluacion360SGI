...
<div class="mbr-section__container container mbr-section__container--isolated">
  ...
  <div class="row container">
    <div class="pull-right">
        ...
        <div class="mbr-navbar__column"><ul class="mbr-navbar__items mbr-navbar__items--right mbr-buttons mbr-buttons--freeze mbr-buttons--right btn-inverse mbr-buttons--active"><li class="mbr-navbar__item">
            <a class="mbr-buttons__btn btn btn-danger active" href="?view=resultados&mode=add">CREAR RESULTADO</a>
        </li></ul></div>
        <div class="mbr-navbar__column"><ul class="mbr-navbar__items mbr-navbar__items--right mbr-buttons mbr-buttons--freeze mbr-buttons--right btn-inverse mbr-buttons--active"><li class="mbr-navbar__item">
  ...
  <div class="row categorias_con_foros">
    <div class="col-sm-12">
        ...
        <div class="row cajas">
          <div class="col-md-12">
            <form class="form-horizontal" action="?view=resultados&mode=add" method="POST" enctype="multipart/form-data">
              <fieldset>
            ...
            <div class="row titulo_categoria">Añadir multiples códigos</div>
              <form action="up_multiple_resultado.php" method="post" enctype="multipart/form-data">
