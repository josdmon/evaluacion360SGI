...
<div class="row categorias_con_foros">
  <div class="col-sm-12">
      ...
      <div class="row cajas">
        <div class="col-md-12">
          <form class="form-horizontal" action="?view=recepcion&mode=edit&id=<?php echo $_GET['id']; ?>" method="POST" enctype="multipart/form-data">
            <fieldset>
              <div class="form-group">
                <label for="inputEmail" class="col-lg-2 control-label">Codigo de la Muestra</label>
                <div class="col-lg-10">
                  <input type="text" class="form-control" maxlength="250" required name="codigo" placeholder="Codigo" value="<?php echo $_recepcion[$_GET['id']]['codigo']; ?>">
                </div>
              </div>
              <div class="form-group">
                <label for="inputEmail" class="col-lg-2 control-label">Proyecto</label>
                <div class="col-lg-10">
                  <input type="text" class="form-control" maxlength="250" name="proyecto" required placeholder="Proyecto de la muestra" value="<?php echo $_recepcion[$_GET['id']]['proyecto']; ?>">
                </div>
              </div>
              <div class="form-group">
                <label for="inputEmail" class="col-lg-2 control-label">Plan de muestreo</label>
                <div class="col-lg-10">
                  <input type="text" class="form-control" maxlength="250" name="plan_muestreo" required placeholder="Plan de muestreo de la muestra" value="<?php echo $_recepcion[$_GET['id']]['plan_muestreo']; ?>">
                </div>
              </div>
              <div class="form-group">
                  ...
                  <select name="cliente" class="form-control">
                    <?php
                      ...
                      foreach($_clientes as $id_cliente => $array_cliente) {
                        if($id_cliente == $_recepcion[$_GET['id']]['id_cliente']) {
                          echo '<option value="'.$id_cliente.'" selected>'.$_clientes[$id_cliente]['user'].'</option>';
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="file" class="filestyle" required name="archivo" value="<?php echo $_recepcion[$_GET['id']]['nombre_archivo']; ?>">
                </div>
              </div>
              <div class="form-group">
                <label class="col-lg-2 control-label">FECHA</label>
                <div class="col-lg-10">
                  <input type="date" class="form-control" required name="fecha" value="<?php echo $_recepcion[$_GET['id']]['f_recepcion']; ?>">
                </div>
              </div>
              <div class="form-group">
