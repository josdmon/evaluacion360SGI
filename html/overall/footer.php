...
<footer class="mbr-section mbr-section--relative mbr-section--fixed-size mbr-parallax-background" id="footer1-4" style="background-image: url(views/images/bg3.jpg);">
    ...
    <div class="mbr-section__container container">
        <div class="mbr-footer mbr-footer--wysiwyg row">
            <div class="col-sm-12">
                <p class="mbr-footer__copyright"> <?= APP_COPY ?> <a class="mbr-footer__link text-gray" href="#/"> Terminos de Uso </a>  | <a class="mbr-footer__link text-gray" href="#/">Política de Privacidad</a></p>
            </div>
        </div>
    </div>
</footer>
  ...
  <script src="views/bootstrap/js/bootstrap-filestyle.min.js"></script>
  ...
  <script src="views/morrisjs/morris.min.js"></script>
  <script src="views/raphael/raphael.min.js"></script>
