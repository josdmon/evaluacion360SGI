...
<div class="mbr-section__container container mbr-section__container--isolated">
  ...
  <div class="row container">
    <div class="pull-right">
      ...
      <div class="mbr-navbar__column"><ul class="mbr-navbar__items mbr-navbar__items--right mbr-buttons mbr-buttons--freeze mbr-buttons--right btn-inverse mbr-buttons--active"><li class="mbr-navbar__item">
          <a class="mbr-buttons__btn btn btn-danger  active" href="?view=plan_accion_hseq&mode=add_general">GENERAL ÁREAS</a>
      </li></ul></div>
    </div>
    <ol class="breadcrumb">
      <li><a href="?view=index"><i class="fa fa-comments"></i> Generales</a></li>
    </ol>
  </div>
  <div class="row categorias_con_foros">
    <div class="col-sm-12">
        <div class="row titulo_categoria">Gestión del plan de accion General</div>
        <div class="row cajas">
          <div class="col-md-12">
            <form class="form-horizontal" action="?view=plan_accion_hseq&mode=add_general" method="POST" enctype="multipart/form-data">
              <fieldset>
                <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <select name="id" class="form-control">
                      <?php
                        if(false != $_planacciongeneral) {
                          foreach($_planacciongeneral as $id => $array_pla) {
                            echo '<option value="'.$id.'">'.$_planacciongeneral[$id]['competencia'].'</option>';
                          }
                        } else {
