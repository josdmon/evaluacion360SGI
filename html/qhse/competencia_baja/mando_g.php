<?php
$min = min($com1,$eft1,$etc1,$hbd1,$ldg1,$prf1,$m_grc1,$grc1);
if($min == $com1)
{
	...
	$min1 =min($eft1,$etc1,$hbd1,$ldg1,$prf1,$m_grc1,$grc1);
	if ($min1 == $eft1) {
		...
		$MEJORA .= '<p>La segunda competencia más baja que tienes es <big><b> HSQ MANDO ALTO. </b></big>';// Por eso te recomendamos trabajar en lo siguiente.</p><br><p><a target=\"_blank\" href="views/app/images/archivos/plan_accion_hseq/'.$_planaccionhseq[10]['mandos_m'].'" title=\"'.$_planaccionhseq[10]['mandos_m'].'\"<span  aria-hidden="true"></span>'.$_planaccionhseq[10]['mandos_m'].'</a></p><br>';
	}elseif($min1 == $grc1){
	...
	$min1 =min($com1,$etc1,$hbd1,$ldg1,$prf1,$m_grc1,$grc1);
	if ($min1 == $com1) {
	...
	$min1 =min($com1,$etc1,$eft1,$ldg1,$prf1,$m_grc1,$grc1);
	if ($min1 == $com1) {
		$MEJORA .= '<p>La segunda competencia más baja que tienes es <big><b> COMUNICACIÓN. </b></big>';// Por eso te recomendamos trabajar en lo siguiente.</p><br><p><a target=\"_blank\" href="views/app/images/archivos/plan_accion_hseq/'.$_planaccionhseq[1]['mandos_m'].'" title=\"'.$_planaccionhseq[1]['mandos_m'].'\"<span  aria-hidden="true"></span>'.$_planaccionhseq[1]['mandos_m'].'</a></p><br>';
	}elseif($min1 == $eft1){
		$MEJORA .= '<p>La segunda competencia más baja que tienes es <big><b> EFECTIVIDAD. </b></big>';// Por eso te recomendamos trabajar en lo siguiente.</p><br><p><a target=\"_blank\" href="views/app/images/archivos/plan_accion_hseq/'.$_planaccionhseq[2]['mandos_m'].'" title=\"'.$_planaccionhseq[2]['mandos_m'].'\"<span  aria-hidden="true"></span>'.$_planaccionhseq[2]['mandos_m'].'</a></p><br>';
	...
	$min1 =min($com1,$etc1,$eft1,$hbd1,$prf1,$m_grc1,$grc1);
	if ($min1 == $com1) {
		$MEJORA .= '<p>La segunda competencia más baja que tienes es <big><b> COMUNICACIÓN. </b></big>';// Por eso te recomendamos trabajar en lo siguiente.</p><br><p><a target=\"_blank\" href="views/app/images/archivos/plan_accion_hseq/'.$_planaccionhseq[1]['mandos_m'].'" title=\"'.$_planaccionhseq[1]['mandos_m'].'\"<span  aria-hidden="true"></span>'.$_planaccionhseq[1]['mandos_m'].'</a></p><br>';
	}elseif($min1 == $eft1){
		$MEJORA .= '<p>La segunda competencia más baja que tienes es <big><b> EFECTIVIDAD. </b></big>';// Por eso te recomendamos trabajar en lo siguiente.</p><br><p><a target=\"_blank\" href="views/app/images/archivos/plan_accion_hseq/'.$_planaccionhseq[2]['mandos_m'].'" title=\"'.$_planaccionhseq[2]['mandos_m'].'\"<span  aria-hidden="true"></span>'.$_planaccionhseq[2]['mandos_m'].'</a></p><br>';
	...
	$min1 =min($com1,$etc1,$eft1,$hbd1,$ldg1,$m_grc1,$grc1);
	if ($min1 == $com1) {
		$MEJORA .= '<p>La segunda competencia más baja que tienes es <big><b> COMUNICACIÓN. </b></big>';// Por eso te recomendamos trabajar en lo siguiente.</p><br><p><a target=\"_blank\" href="views/app/images/archivos/plan_accion_hseq/'.$_planaccionhseq[1]['mandos_m'].'" title=\"'.$_planaccionhseq[1]['mandos_m'].'\"<span  aria-hidden="true"></span>'.$_planaccionhseq[1]['mandos_m'].'</a></p><br>';
	}elseif($min1 == $eft1){
		$MEJORA .= '<p>La segunda competencia más baja que tienes es <big><b> EFECTIVIDAD. </b></big>';// Por eso te recomendamos trabajar en lo siguiente.</p><br><p><a target=\"_blank\" href="views/app/images/archivos/plan_accion_hseq/'.$_planaccionhseq[2]['mandos_m'].'" title=\"'.$_planaccionhseq[2]['mandos_m'].'\"<span  aria-hidden="true"></span>'.$_planaccionhseq[2]['mandos_m'].'</a></p><br>';
	...
	$min1 =min($com1,$prf1,$eft1,$hbd1,$ldg1,$m_grc1,$grc1);
	if ($min1 == $com1) {
		$MEJORA .= '<p>La segunda competencia más baja que tienes es <big><b> COMUNICACIÓN. </b></big>';// Por eso te recomendamos trabajar en lo siguiente.</p><br><p><a target=\"_blank\" href="views/app/images/archivos/plan_accion_hseq/'.$_planaccionhseq[1]['mandos_m'].'" title=\"'.$_planaccionhseq[1]['mandos_m'].'\"<span  aria-hidden="true"></span>'.$_planaccionhseq[1]['mandos_m'].'</a></p><br>';
	}elseif($min1 == $eft1){
		$MEJORA .= '<p>La segunda competencia más baja que tienes es <big><b> EFECTIVIDAD. </b></big>';// Por eso te recomendamos trabajar en lo siguiente.</p><br><p><a target=\"_blank\" href="views/app/images/archivos/plan_accion_hseq/'.$_planaccionhseq[2]['mandos_m'].'" title=\"'.$_planaccionhseq[2]['mandos_m'].'\"<span  aria-hidden="true"></span>'.$_planaccionhseq[2]['mandos_m'].'</a></p><br>';
	...
	$MEJORA = '<p>La competencia más baja que tienes es <big><b> HSQ MANDO ALTO. </b></big>';// Por eso te recomendamos trabajar en lo siguiente.</p><br><p><a target=\"_blank\" href="views/app/images/archivos/plan_accion_hseq/'.$_planaccionhseq[10]['mandos_m'].'" title=\"'.$_planaccionhseq[10]['mandos_m'].'\"<span  aria-hidden="true"></span>'.$_planaccionhseq[10]['mandos_m'].'</a></p><br>';
	...
	$min1 =min($com1,$prf1,$eft1,$hbd1,$ldg1,$m_grc1);
	if ($min1 == $com1) {
		$MEJORA .= '<p>La segunda competencia más baja que tienes es <big><b> COMUNICACIÓN. </b></big>';// Por eso te recomendamos trabajar en lo siguiente.</p><br><p><a target=\"_blank\" href="views/app/images/archivos/plan_accion_hseq/'.$_planaccionhseq[1]['mandos_m'].'" title=\"'.$_planaccionhseq[1]['mandos_m'].'\"<span  aria-hidden="true"></span>'.$_planaccionhseq[1]['mandos_m'].'</a></p><br>';
	}elseif($min1 == $eft1){
		$MEJORA .= '<p>La segunda competencia más baja que tienes es <big><b> EFECTIVIDAD. </b></big>';// Por eso te recomendamos trabajar en lo siguiente.</p><br><p><a target=\"_blank\" href="views/app/images/archivos/plan_accion_hseq/'.$_planaccionhseq[2]['mandos_m'].'" title=\"'.$_planaccionhseq[2]['mandos_m'].'\"<span  aria-hidden="true"></span>'.$_planaccionhseq[2]['mandos_m'].'</a></p><br>';
