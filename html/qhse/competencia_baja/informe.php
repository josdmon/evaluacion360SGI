...
$pdf->Cell(30, 30, 'Fecha del informe', 1, 0, 'C');
...
$min2 = min($grc1,$m_grc1,$m_md1,$m_hse1);
...
if ($com1 < 3.5 or $eft1 < 3.5 or $hbd1 < 3.5 or $ldg1 < 3.5 or $prf1 < 3.5 or $etc1 < 3.5) {
  ...
  $pdf->MultiCell(190, 10, utf8_decode('Debes mejorar tu desempeño en las competencias por debajo de 3.5, se recomienda ver en la plataforma el plan de acción para la competencia afectada.'), 0,'C', 0 );
  if($min == $com1)  {
      $pdf->SetXY(15,188);
   ...
   if ($grc1 < 3.5 or $m_md1 < 3.5) {
     ...
     if($min2 == $grc1)  {
       ...
       $pdf->SetXY(15,188);
       $pdf->SetFont('Arial','B',20);
       $pdf->MultiCell(190, 10, utf8_decode('La competencia más baja es: HSQ MANDO MEDIO. Tienes que mantener una mejora a partir de la fecha  22 de Marzo del año 2018 a la fecha 22 de Septiembre del año 2018, con compromisos de entrega de resultados con tu jefe inmediato. Las mejoras serán publicadas en la plataforma, en la parte desempeño bajo.'), 0,'C', 0 );
     ...
     $pdf->Cell(25, 10, utf8_decode('Fecha de revición'), 1, 0 ,'C',1);
     ...
     $pdf->MultiCell(20, 5, utf8_decode('Firma en a revición'), 1,'C',1);
