...
//$path = "C:/xampp/htdocs/app/views/app/images/archivos/recepcion/"; // Upload directory
$path ="views/app/images/archivos/recepcion/";
	    ...
	    if ($_FILES['files']['error'][$f] == 0) {	           
			...
			elseif( ! in_array(pathinfo($name, PATHINFO_EXTENSION), $valid_formats) ){
				...
				if($filas_devueltas >0){
					$query=$db->query("UPDATE recepcion SET nombre_archivo = '$name' WHERE codigo = '$codigo_extraido'");
